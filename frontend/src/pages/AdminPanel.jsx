                ...
                <aside className=" absolute h-full w-64 bg-gray-900 text-white z-50">
                    <div className="p-4">
                        <div className="flex items-center space-x-2">
                            ...
                            <span className="text-xl font-bold">ZIARA</span>
                        </div>
                    ...
                    <nav className="mt-8">
                        <div className="px-4 space-y-1">
                            <button onClick={()=>setActivo('dashboard')} className={`flex items-center px-4 py-3 text-sm ${activo === "dashboard" ? "bg-gray-800 text-white" : "text-gray-300 hover:bg-gray-800"}  rounded-lg`}>
