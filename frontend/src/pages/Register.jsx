                    ...
                    <div className="col-12 col-md-6 col-lg-4">
                        <div className="card shadow-lg border-0 rounded-3 p-4">
                            <div className="text-center mb-4">
                                ...
                                <p className="text-muted">Registra tu cuenta con nosotros</p>
                            </div>
                            ...
                            <p className="mt-4 text-center text-muted small">
                                ...
                                <Link to='/login' className="text-decoration-none text-warning fw-medium ms-1">
                                    Inicia aquí
                                </Link>
                            </p>
                            ...
                            <div className="mt-4">
                                <div className="position-relative">
                                    ...
                                    <div className="position-relative text-center">
                                        <span className="bg-white px-3 text-muted small">O Registrate con</span>
                                    </div>
                                </div>
